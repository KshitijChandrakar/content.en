...
AAAAAA = keypoints_and_edges_for_display
def draw_prediction_on_image(
  ...
  scat1 = ax.scatter((np.mean(keypoint_locs, axis =0 )[0],), (np.mean(keypoint_locs, axis =0)[1],), s=100, color='#FF0000', zorder=3)
...
# movenet = tf.saved_model.load('../Movenet')
movenet = hub.load("https://tfhub.dev/google/movenet/singlepose/lightning/4")
input_size = 192
def movenet1(input_image):
